        ...
        <div className=" col-span-2 border-2 rounded-2xl px-5 py-6 border-[#6696ffff] shadow-[1px_0px_11px_3px_#6696ff]">
          ...
          <section>
            <h1>
              ...
              <b> Chain2055</b> as a graphic designer as well as moderating crypto
              project, communities and collaborated on innovative projects.{" "}
            </h1>
            ...
            <h1>
              ...
              from <b>LASkill </b> and have served as a community moderator, collab
              manager and shiller on both Discord and Telegram. Send a message
              and let&rsquo;s get creative.
            </h1>
