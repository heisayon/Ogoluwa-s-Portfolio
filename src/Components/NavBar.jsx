...
function NavBar() {
  ...
  return (
    <div className="relative">
      <div className="fixed top-0 right-0 left-0 py-5 px-6 h-20 w-full z-20 backdrop-blur-sm bg-white/0">
      ...
      {navState && (
        <div className="fixed top-[50px] bg-white/0 backdrop-blur-sm right-0 left-0 h-[30%] bg-white md:hidden z-30">
