...
function FeaturedWork() {
  return (
    <div className="grid lg:grid-cols-2 max-lg:grid-cols-1 gap-9">
      <motion.div
        className="md:w-[500px] md:h-[500px] max-md:w-full max-md:h-full flex justify-center items-center overflow-hidden rounded-2xl cursor-pointer"
        initial={{ opacity: 0 }}
      ...
      >
        <img
          src={Work1}
          alt="Chain 2055"
          className="w-[90%] h-full hover:scale-105 transition-all"
        />
      </motion.div>
      <motion.div
        className="md:w-[500px] md:h-[500px] max-md:w-full max-md:h-full flex justify-center items-center overflow-hidden rounded-2xl cursor-pointer"
